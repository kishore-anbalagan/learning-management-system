...
exports.signup = async (req, res) => {
    try {
        ...
        let approved = true;
        // For instructor accounts, they might need approval
        if (accountType === "Instructor") {
            approved = false; // Set to false if instructors need manual approval
        }
...
exports.login = async (req, res) => {
    try {
        ...
        if (await bcrypt.compare(password, user.password)) {
            ...
            // Create redirectTo path based on accountType
            let redirectTo = '/dashboard/my-profile';
            let userType = user.accountType;

            // If accountType is provided in the request and user has that role, use it for redirection
            // This helps when user selects their role on the login page
            if (accountType && 
                (accountType === 'Student' || accountType === 'Instructor' || accountType === 'Admin') &&
            ...
            if (userType === 'Student') {
                ...
                redirectTo = '/dashboard/all-students';
            }
