...
// Replaced missing fetchCourseDetails with getCourseDetails from courseAPI
import { getCourseDetails, enrollInCourse } from "../services/operations/courseAPI"
...
function CourseDetails() {
  ...
  useEffect(() => {
    ...
    const fetchCourse = async () => {
      try {
        ...
        setResponse({ data: { courseDetails: res.courseDetails || res.course || res } })
      } catch (error) {
  ...
  const handleBuyCourse = async () => {
    ...
    try {
      ...
      // Post-enrollment navigation could go to dashboard or course view
  ...
  const handleAddToCart = () => {
    // Cart feature deprecated; using same flow as enroll
    handleBuyCourse()
  }
